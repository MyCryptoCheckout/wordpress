	...
	extends Component
{
	...
	**/
	...
	/**
		...
		@details	The retrieve key is a random key sent to the server, which is sent back to us with the new account data.
	...
	**/
	public function retrieve()
	{
		try
		{
			...
			$result = $this->api()->send_post( 'account/retrieve',
				[
